...
def parse_opt():
    ...
    parser.add_argument("--source", type=str, default=ROOT /"wzry\\datasets\\images\\test\\SVID_20210726_111258_1.mp4", help="file/dir/URL/glob/screen/0(webcam)")
    parser.add_argument("--data", type=str, default=ROOT / "wzry\\wzry_parameter.yaml", help="(optional) dataset.yaml path")
