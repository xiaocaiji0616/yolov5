...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="", help="wzry_model.yaml path")##
    parser.add_argument("--data", type=str, default=ROOT / "data/wzry_parameter.yaml", help="dataset.yaml path")
